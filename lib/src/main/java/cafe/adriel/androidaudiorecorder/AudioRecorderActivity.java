...
import cafe.adriel.androidaudiorecorder.customViews.BoldTextView;
...
public class AudioRecorderActivity extends AppCompatActivity
    ...
    private BoldTextView statusView;
    private BoldTextView timerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        visualizerView = new GLAudioVisualizationView.Builder(this)
                ...
                .setBubblesPerLayer(1000)
                .setBubblesSize(R.dimen.aar_bubble_size)
                .setBubblesRandomizeSize(true)
                .setBackgroundColor(Util.getDarkerColor(color))
                .setLayerColors(new int[]{R.color.colorAccent, R.color.colorPrimary})
                .build();

        contentLayout = (RelativeLayout) findViewById(R.id.content);
        statusView = (BoldTextView) findViewById(R.id.status);
        timerView = (BoldTextView) findViewById(R.id.timer);
        ...
        if(Util.isBrightColor(color)) {
            ...
            restartView.setColorFilter(Color.WHITE);
            recordView.setColorFilter(Color.WHITE);
            playView.setColorFilter(Color.WHITE);
        }
    }
